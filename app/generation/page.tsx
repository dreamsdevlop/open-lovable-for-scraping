...
import KiloSidebar from '@/components/KiloSidebar';
      ...
      <div className="font-sans bg-background text-foreground h-screen flex flex-col">
        <div className="bg-white py-[15px] py-[8px] border-b border-border-faint flex items-center justify-between shadow-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3 py-1.5 text-sm text-gray-900 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-gray-300 transition-colors min-w-[200px]"
            >
              {/* ⚡ NEW - Llama 4 */}
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            ...
            {/* Kilo Chat Sidebar */}
            <KiloSidebar
              isOpen={isKiloSidebarOpen}
              onToggle={() => setIsKiloSidebarOpen(!isKiloSidebarOpen)}
            />
          </div>
        </div>

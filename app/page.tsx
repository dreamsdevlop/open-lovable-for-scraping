            ...
            <div className="max-w-552 mx-auto z-[11] lg:z-[2]">
              <div className="rounded-20 -mt-30 lg:-mt-30">
                ...
                >
                  ...
                  <div className={`overflow-hidden transition-all duration-500 ease-in-out ${isValidUrl ? (extendBrandStyles ? 'max-h-[400px]' : 'max-h-[300px]') + ' opacity-100' : 'max-h-0 opacity-0'
                    }`}>
                    <div className="px-[28px] pt-0 pb-[28px]">
                      <div className="border-t border-gray-100 bg-white">
                        {/* Extend Brand Styles Toggle */}
                        <div className={`transition-all duration-300 transform ${isValidUrl ? 'translate-y-0 opacity-100' : '-translate-y-2 opacity-0'
                        ...
                        {!extendBrandStyles && (
                          <div className={`mb-2 transition-all duration-300 transform ${isValidUrl ? 'translate-y-0 opacity-100' : '-translate-y-2 opacity-0'
                        ...
                        <div className={`flex items-center gap-3 mt-2 pb-4 transition-all duration-300 transform ${isValidUrl ? 'translate-y-0 opacity-100' : '-translate-y-2 opacity-0'
                          }`} style={{ transitionDelay: '400ms' }}>
                          {/* Model Dropdown */}
                          <select
                            value={selectedModel}
                            onChange={(e) => setSelectedModel(e.target.value)}
                            className={`px-3 py-2.5 text-xs font-medium text-gray-700 bg-white rounded border border-gray-200 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500 ${extendBrandStyles ? 'flex-1' : ''} min-w-[180px]`}
                          >
                            {/* ⚡ NEW - Llama 4 */}
                            <optgroup label="⚡ LLAMA 4 (Latest Free)">
                              <option value="openrouter/meta-llama/llama-4-scout-17b-16e-instruct">Llama 4 Scout 17B • 200K</option>
                              <option value="openrouter/meta-llama/llama-4-maverick-17b-8e-instruct">Llama 4 Maverick 17B • 200K</option>
                            </optgroup>
                            {/* 🟡 NVIDIA */}
                            <optgroup label="🟡 NVIDIA NEMOTRON (Free)">
                              <option value="openrouter/nvidia/llama-3.1-nemotron-70b-instruct">Nemotron 70B • 128K</option>
                              <option value="openrouter/nvidia/llama-3.3-nemotron-70b-instruct">Nemotron 70B v2 • 128K</option>
                            </optgroup>
                            {/* 🟡 Gemma 3 */}
                            <optgroup label="🟡 GEMMA 3 (Latest Free)">
                              <option value="openrouter/google/gemma-3-27b-it">Gemma 3 27B • 128K</option>
                              <option value="openrouter/google/gemma-3-12b-it">Gemma 3 12B • 128K</option>
                              <option value="openrouter/google/gemma-3-4b-it">Gemma 3 4B • 128K</option>
                              <option value="openrouter/google/gemma-3-1b-it">Gemma 3 1B • 128K</option>
                            </optgroup>
                            {/* 🟡 LLAMA 3.x */}
                            <optgroup label="🟡 LLAMA 3.x (Free)">
                              <option value="openrouter/meta-llama/llama-3.3-70b-instruct">Llama 3.3 70B • 128K</option>
                              <option value="openrouter/meta-llama/llama-3.1-70b-instruct">Llama 3.1 70B • 128K</option>
                              <option value="openrouter/meta-llama/llama-3.1-8b-instruct">Llama 3.1 8B • 128K</option>
                            </optgroup>
                            {/* 🟡 Other Free */}
                            <optgroup label="🟡 OTHER FREE MODELS">
                              <option value="openrouter/google/gemini-2.0-flash-exp:free">Gemini 2 Flash • 1M</option>
                              <option value="openrouter/ai-anything/gpt-4o-mini">GPT-4o Mini • 128K</option>
                              <option value="openrouter/qwen/qwen-2.5-72b-instruct">Qwen 2.5 72B • 128K</option>
                              <option value="openrouter/qwen/qwen-2.5-32b-instruct">Qwen 2.5 32B • 128K</option>
                              <option value="openrouter/qwen/qwen-2.5-14b-instruct">Qwen 2.5 14B • 128K</option>
                              <option value="openrouter/mistralai/mistral-small-3.1-24b-instruct">Mistral Small 24B • 128K</option>
                              <option value="openrouter/mistralai/mistral-7b-instruct">Mistral 7B • 128K</option>
                              <option value="openrouter/cognition-labs/cognitive-llama-8b">Cognitive Llama 8B • 128K</option>
                              <option value="openrouter/NousResearch/hermes-3-llama-3.1-8b">Hermes 3 Llama • 128K</option>
                              <option value="openrouter/01-ai/yi-1.5-34b-instruct">Yi 1.5 34B • 128K</option>
                              <option value="openrouter/01-ai/yi-1.5-9b-instruct">Yi 1.5 9B • 128K</option>
                              <option value="openrouter/google/gemma-2-9b-it">Gemma 2 9B • 128K</option>
                              <option value="openrouter/google/gemma-2-27b-it">Gemma 2 27B • 128K</option>
                            </optgroup>
                            {/* 🔵 Reasoning */}
                            <optgroup label="🔵 REASONING MODELS">
                              <option value="openrouter/openai/_reasoning-model">OpenAI Reasoner • 200K</option>
                              <option value="openrouter/deepseek/deepseek-prover">DeepSeek Prover • 64K</option>
                            </optgroup>
                            {/* 🟢 Cheap */}
                            <optgroup label="🟢 CHEAP / DISCOUNTED">
                              <option value="openrouter/amazon/nova-lite-v1">Nova Lite • 1M</option>
                              <option value="openrouter/amazon/nova-micro-v1">Nova Micro • 128K</option>
                              <option value="openrouter/deepseek/deepseek-chat">DeepSeek Chat • 64K</option>
                              <option value="openrouter/deepseek/deepseek-coder">DeepSeek Coder • 64K</option>
                              <option value="moonshotai/kimi-k2-instruct-0905">Kimi K2 (Groq) • 128K</option>
                            </optgroup>
                            {/* 🔴 Paid */}
                            <optgroup label="🔴 PAID / PREMIUM">
                              <option value="openai/gpt-5">GPT-5 • 128K</option>
                              <option value="anthropic/claude-sonnet-4-20250514">Claude Sonnet 4 • 200K</option>
                              <option value="google/gemini-3-pro-preview">Gemini 3 Pro • 1M</option>
                            </optgroup>
                          </select>
